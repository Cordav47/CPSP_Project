...
class ImagePublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Image, 'standard_image_topic', 10)
        ...
        self.image_folder = '/home/dc7/CPS/Project/ros2_ws/Standard_images'  # Set your folder path here
    ...
    def publish_image(self):
        ...
        if cv_image is not None:
            ros_image = self.bridge.cv2_to_imgmsg(cv_image, encoding='bgr8')
            self.publisher_.publish(ros_image)
            self.get_logger().info(f'Published standard image: {image_name}')
